...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2025-03-08 10:25:05" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2025-03-08 10:24:04" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2025-03-08 10:25:05" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2025-03-08 10:25:05" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2025-03-08 10:25:05" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2025-03-08 10:25:05" nil (:type git :host github :repo "dimitri/el-get" :build nil :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2025-03-08 10:25:05" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2025-03-08 10:25:05" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2025-03-08 10:25:05" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "lsp-bridge" ("2025-03-08 10:25:05" ("emacs" "markdown-mode") (:type git :host github :repo "manateelazycat/lsp-bridge" :files (:defaults "*.el" "*.py" "acm" "core" "langserver" "multiserver" "resources") :build (:not compile) :package "lsp-bridge" :local-repo "lsp-bridge")) "markdown-mode" ("2025-03-08 10:25:05" ("emacs") (:type git :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "winum" ("2025-03-08 10:25:13" ("cl-lib" "dash") (:type git :host github :repo "deb0ch/emacs-winum" :package "winum" :local-repo "emacs-winum")) "dash" ("2025-03-08 10:25:13" ("emacs") (:type git :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "which-key" ("2025-03-08 10:25:13" ("emacs") (:type git :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "evil" ("2025-03-08 10:25:13" ("emacs" "cl-lib" "goto-chg" "nadvice") (:type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2025-03-08 10:25:13" ("emacs") (:type git :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "keyfreq" ("2025-01-15 09:47:07" ("cl-lib") (:type git :host github :repo "dacap/keyfreq" :package "keyfreq" :local-repo "keyfreq")) "graphviz-dot-mode" ("2025-01-15 08:57:30" ("emacs") (:type git :host github :repo "ppareit/graphviz-dot-mode" :package "graphviz-dot-mode" :local-repo "graphviz-dot-mode")) "cnfonts" ("2025-03-08 10:25:14" ("emacs") (:type git :host github :repo "tumashu/cnfonts" :package "cnfonts" :local-repo "cnfonts")) "racket-mode" ("2025-03-08 10:25:14" ("emacs") (:type git :files (:defaults "*.rkt" ("racket" "racket/*") (:exclude "racket/example/*" "racket/test/*") "racket-mode-pkg.el") :host github :repo "greghendershott/racket-mode" :package "racket-mode" :local-repo "racket-mode")) "paredit" ("2025-03-08 10:25:16" nil (:type git :repo "https://mumble.net/~campbell/git/paredit.git" :package "paredit" :local-repo "paredit")) "ledger-mode" ("2025-01-15 08:57:31" ("emacs") (:type git :files ("ledger-*.el" "doc/*.texi" "ledger-mode-pkg.el") :host github :repo "ledger/ledger-mode" :package "ledger-mode" :local-repo "ledger-mode")) "yasnippet" ("2025-03-08 10:25:05" ("cl-lib" "emacs") (:type git :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet" :package "yasnippet" :local-repo "yasnippet")) "epc" ("2025-03-08 10:25:08" ("concurrent" "ctable") (:type git :files ("epc.el" "epcs.el" "epc-pkg.el") :host github :repo "kiwanami/emacs-epc" :package "epc" :local-repo "emacs-epc")) "concurrent" ("2025-03-08 10:25:08" ("emacs" "deferred") (:type git :files ("concurrent.el" "concurrent-pkg.el") :host github :repo "kiwanami/emacs-deferred" :package "concurrent" :local-repo "emacs-deferred")) "deferred" ("2025-03-08 10:25:08" ("emacs") (:files ("deferred.el" "deferred-pkg.el") :package "deferred" :local-repo "emacs-deferred" :type git :repo "kiwanami/emacs-deferred" :host github)) "ctable" ("2025-03-08 10:25:08" ("emacs" "cl-lib") (:type git :files ("ctable.el" "ctable-pkg.el") :host github :repo "kiwanami/emacs-ctable" :package "ctable" :local-repo "emacs-ctable")) "posframe" ("2025-03-08 10:25:08" ("emacs") (:type git :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "elfeed-org" ("2025-03-08 10:25:11" ("elfeed" "org" "cl-lib") (:type git :host github :repo "remyhonig/elfeed-org" :package "elfeed-org" :local-repo "elfeed-org")) "elfeed" ("2025-03-08 10:25:08" ("emacs") (:type git :files (:defaults "README.md" "elfeed-pkg.el") :host github :repo "skeeto/elfeed" :package "elfeed" :local-repo "elfeed")) "org" ("2025-03-08 10:25:11" ("emacs") (:type git :repo "https://git.savannah.gnu.org/git/emacs/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org"))))
